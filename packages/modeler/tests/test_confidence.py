...
class TestComputeConfidence:
    ...
    def snapshot(self) -> OptionSurfaceSnapshot:
        ...
        calls = (
            OptionPoint(strike_price=90.0, option_type="call", bid=11.9, ask=12.1, mid=12.0, spread=0.2),
            OptionPoint(strike_price=100.0, option_type="call", bid=4.9, ask=5.1, mid=5.0, spread=0.2),
            OptionPoint(strike_price=110.0, option_type="call", bid=0.9, ask=1.1, mid=1.0, spread=0.2),
        )
        puts = (
            OptionPoint(strike_price=90.0, option_type="put", bid=0.9, ask=1.1, mid=1.0, spread=0.2),
            OptionPoint(strike_price=100.0, option_type="put", bid=4.9, ask=5.1, mid=5.0, spread=0.2),
            OptionPoint(strike_price=110.0, option_type="put", bid=11.9, ask=12.1, mid=12.0, spread=0.2),
        )
    ...
    def test_liquidity_score_with_wide_spreads(self) -> None:
        calls = (
            OptionPoint(strike_price=90.0, option_type="call", bid=10.0, ask=14.0, mid=12.0, spread=4.0),
            OptionPoint(strike_price=100.0, option_type="call", bid=3.0, ask=7.0, mid=5.0, spread=4.0),
            OptionPoint(strike_price=110.0, option_type="call", bid=0.0, ask=2.0, mid=1.0, spread=2.0),
        )
        puts = (OptionPoint(strike_price=100.0, option_type="put", bid=3.0, ask=7.0, mid=5.0, spread=4.0),)
    ...
    def test_monotonicity_score_good(self, snapshot: OptionSurfaceSnapshot) -> None:
        """Calls decrease with strike_price -> monotonicity = 1.0."""
        prob = 0.5
    ...
    def test_monotonicity_score_bad(self) -> None:
        """Calls increase with strike_price (arbitrage) -> monotonicity = 0.0."""
        calls = (
            OptionPoint(strike_price=90.0, option_type="call", bid=0.9, ask=1.1, mid=1.0, spread=0.2),
            OptionPoint(strike_price=100.0, option_type="call", bid=4.9, ask=5.1, mid=5.0, spread=0.2),
            OptionPoint(strike_price=110.0, option_type="call", bid=11.9, ask=12.1, mid=12.0, spread=0.2),
        )
        puts = (OptionPoint(strike_price=100.0, option_type="put", bid=4.9, ask=5.1, mid=5.0, spread=0.2),)
        snapshot = OptionSurfaceSnapshot(symbol=TEST_SYMBOL, expiration_date=TEST_EXPIRY, calls=calls, puts=puts)
        prob = 0.5
    ...
    def test_spacing_score_at_edge(self) -> None:
        """strike_price at edge of chain -> spacing = 0."""
        calls = (
            OptionPoint(strike_price=100.0, option_type="call", bid=4.9, ask=5.1, mid=5.0, spread=0.2),
            OptionPoint(strike_price=110.0, option_type="call", bid=0.9, ask=1.1, mid=1.0, spread=0.2),
        )
